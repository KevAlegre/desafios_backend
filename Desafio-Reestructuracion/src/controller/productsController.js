import {getProductsService, getProductByIdService, createProductService, updateProductService, deteleProductServices} from "../services/productsServices.js";
...
export const deleteProduct = async (req, res) => {
    try {
        const productId = req.params.pid;
        const deletedProduct = await deteleProductServices(productId);
